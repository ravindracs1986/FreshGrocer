...
import com.fresh.grocer.configuration.ConfigConstants;
import com.fresh.grocer.googleapi.model.GoogleApiResponse;
import com.fresh.grocer.googleapi.model.Item;
...
import com.fresh.grocer.util.DateUtil;
	...
	private String cronTime;
	 ...
	 //@Scheduled(cron = "0 0 12 * * ?")//Fires at 12 PM every day:
	    public void updateLikeViewComments() {
	        ...
	        String batchFlag=environment.getRequiredProperty("job.schedular.flag");
	        if(batchFlag.equalsIgnoreCase("Y")){
	        	...
	        	System.out.println("Batch is OFF");
	        }
	   }
