...
@ComponentScan("com.fresh.grocer.persist")
@EnableJpaRepositories(basePackages = { "com.fresh.grocer.persist.repo"},transactionManagerRef="transactionManager")
@PropertySource(value = { "classpath:fresh-grocer-portal.properties" })
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.fresh.grocer.persist.*" });
