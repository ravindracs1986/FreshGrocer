...
@EnableWebMvc
//@EnableScheduling
@ComponentScan(basePackages = "com.fresh.grocer")
public class FreshGrocerConfig extends WebMvcConfigurerAdapter{

	private static final Logger LOGGER = LoggerFactory.getLogger(FreshGrocerConfig.class);
    ...
    @Bean
   	...
   	//FileSystemResource[] resources = new FileSystemResource[]{ new FileSystemResource( getPropertyPath() + ConfigConstants.PROPERTIES_EXT )};
   	    ppc.setLocations( new ClassPathResource("fresh-grocer-portal.properties") );
